...
BOT_TOKEN = environ.get('BOT_TOKEN', '7508002697:AAF0ahNayoyHiAg3ayHBX5AErScYRDwwbP8')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://WayK:m3olvidexD@nesscloud.oqcpd.mongodb.net")
DATABASE_NAME = environ.get('DATABASE_NAME', "WayK")
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002260222146'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002260222146')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002409857165'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002409857165') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002449546925')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/NESS_Soporte') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://i.ibb.co/1fVshQGQ/photo-2025-03-04-20-18-56-7478051495611465732.jpg https://i.ibb.co/1fVshQGQ/photo-2025-03-04-20-18-56-7478051495611465732.jpg')).split()
